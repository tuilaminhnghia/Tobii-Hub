local SpeedHubX = loadstring(game:HttpGet("https://raw.githubusercontent.com/tuilaminhnghia/concacmay/main/Library.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/tuilaminhnghia/concacmay/main/SaveManager.lua"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/tuilaminhnghia/concacmay/main/Interface.lua"))()
...
local Window = SpeedHubX:CreateWindow({
    Title = "Tobii Hub | Blox Fruit ",
    SubTitle = "by MinhNghia",
    TabWidth = 160,
...
function LoadSettings()
    if readfile and writefile and isfile and isfolder then
        if not isfolder("TobiiHub") then
            makefolder("TobiiHub")
        end
        if not isfolder("TobiiHub/Blox Fruits/") then
            makefolder("TobiiHub/Blox Fruits/")
        end
        if not isfile("TobiiHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
            writefile("TobiiHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
        else
            local Decode = game:GetService("HttpService"):JSONDecode(readfile("TobiiHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
    if readfile and writefile and isfile and isfolder then
        if not isfile("TobiiHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
            ...
            writefile("TobiiHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
        end
    else
        return warn("Status: error")
    end
...
function GetMaterial(matname)
    ...
    Tabs.Main:AddButton({
        ...
        WeaponList = {"Melee","Sword","Blox Fruit" }
